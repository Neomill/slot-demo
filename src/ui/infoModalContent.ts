...
export const INFO_MODAL_TABS: InfoModalTab[] = [
  ...
  },
  {
    ...
    content: [
      "HOW TO PLAY",
      "The game is played on 5 reels, 3 rows and 15 fixed paylines.",
      "- Choose the bet size using the buttons in the Total Bet field.",
      "- The total bet is the per-line bet multiplied by the 15 paylines.",
      ...
      "",
      "BONUS SYMBOL",
      "Landing 3 Bonus symbols anywhere in a single main-game spin triggers the Free Spins feature.",
      "If a winning combination is formed on the same spin that triggers Free Spins, that win is paid before the Free Spins round begins.",
      "",
      "FREE SPINS",
      "3 Bonus symbols award 10 Free Spins.",
      "Free Spins are played at the same bet as the triggering spin.",
      "Wild symbols appear during Free Spins and drive the rising multiplier.",
      "",
      "WILD SYMBOL",
      ...
      "For every 4 Wilds that appear during Free Spins, the feature retriggers and awards 10 additional Free Spins.",
      "The feature can be retriggered up to 3 times.",
      "Each retrigger raises the win multiplier:",
      "- First retrigger (4 Wilds): ×2.",
      "- Second retrigger (8 Wilds): ×3.",
      "- Third retrigger (12 Wilds): ×10.",
      ...
      "",
      "PRIZE SYMBOLS",
      "There are three types of Prize symbol, each landing with a random value (a multiplier of the bet per line):",
      "- Blue: ×0.5 or ×0.75.",
      "- Red: ×1 or ×1.5.",
      "- Gold: ×2.5 or ×5.",
      "",
      "PRIZE SYMBOLS IN THE MAIN GAME",
      "If 3 or more Prize symbols appear on a payline during the main game, the summed value of those Prize symbols is paid.",
      "",
      ...
      "Landing 5 Trophy symbols on a single main-game spin triggers the Hold & Respin feature.",
      ...
      "- If one or more new Trophy symbols land, they lock and the respin counter resets to 3.",
      "- A win on a respin also resets the respin counter to 3.",
      "- Otherwise the respin counter decreases by 1.",
      "Each locked Trophy carries a value of ×2, ×5, ×10, ×20 or ×50 the bet per line. All Trophy values are collected when the feature ends.",
      "The feature ends when the respin counter reaches 0, after which play returns to the main game.",
      "",
      "BUY BONUS",
      "Buy Bonus purchases the Free Spins feature directly from the main game for 75× the total bet (shown on the Buy Bonus button).",
      "It awards 10 Free Spins and is played exactly like a naturally triggered feature, with the multiplier rising up to ×10.",
      "The price changes with the bet, and Buy Bonus is available only during the main game.",
      "",
      "BUY HOLD & RESPIN",
      ...
      "- A spin may trigger the Free Spins or Hold & Respin feature.",
    ].join("\n"),
  },
];
