# Derby Slot Game Rules

> **Purpose**
>
> This document is a Markdown version of the official Derby game rules. It is intended to serve as the authoritative reference for the game's mechanics. If a mechanic is not described in this document, it should not be assumed.

---

# About the Game

The gates fly open, hooves pound the earth, manes fly, and hearts tremble with excitement and adrenaline—this is Derby for you!

The game includes the following features:

- Bonus symbols trigger Free Spins with Wilds and generous multipliers.
- Three types of Prize symbols carry multipliers of up to ×5.
- Trophy symbols trigger the Hold & Respin feature.
- Spin the reels and start the race.
...
Hold the **Spin** button to choose the number of rounds to auto spin.

After making a selection, a confirmation pop-up displays:

- Number of spins
- Total amount to be deducted

The total amount equals:

**Number of spins × Total Bet**

To start Autospins, click **Confirm**.

To return to manual play, click **Cancel**.
...
Retrigger multipliers are:

| Retrigger | Multiplier |
| --------- | ---------: |
| First     |         ×2 |
| Second    |         ×3 |
| Third     |        ×10 |
...
Hold & Respin is triggered only during the main game. Winning combinations formed on the board during the feature are paid according to the paytable and added to the feature total.

---

## Buy Bonus

Players can purchase one of the following bonus features.

### Super Bonus

Activates Free Spins with multipliers up to **×10**.

### Mega Bonus

Activates Free Spins with multipliers up to **×25**.

### Ultra Bonus

Activates Free Spins with multipliers up to **×100**.

After clicking the **Buy Bonus** button, the purchase prices are displayed in a pop-up.

The purchase price depends on the current bet. If the bet changes, the purchase prices change accordingly.

The next spin after the purchase triggers the Free Spins feature.
...
The Spin Counter displays how many spins have been played.

The counter resets whenever Free Spins are triggered or purchased.
...
- Free Spins are played using the same bet as the triggering round.
